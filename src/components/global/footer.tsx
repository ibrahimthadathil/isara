const Footer = () => {
  return (
    <footer
      className={`bg-secondary dark:bg-background-8 relative overflow-hidden `}
    >
      <figure
        data-ns-animate
        data-delay="0.4"
        ...
        <div className="grid grid-cols-12 xl:pt-[90px] gap-x-0 gap-y-16 pt-16 pb-12 justify-between">
          <div className="col-span-12 xl:col-span-6">
            <div data-ns-animate data-delay="0.3" className="max-w-[500px]">
              <figure>
                <img src="img-isaras/t-2-white.svg" alt="NextSass Logo" />
              </figure>
              <p className="text-accent/60 font-normal text-tagline-1 mt-4 mb-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="https://www.instagram.com/i_saras_ai/"
                  target="_blank"
                  className="footer-social-link"
                  rel="noopener noreferrer"
                >
                ...
                <div className="h-6 w-px bg-stroke-1/20"></div>
                <a
                  href="https://x.com/I_Saras_AI"
                  target="_blank"
                  className="footer-social-link"
                  rel="noopener noreferrer"
                >
                  <span className="sr-only">X</span>
                  <img src="img-isaras/x.svg" alt="X" />
                </a>
                <div className="h-6 w-px bg-stroke-1/20"></div>
                <a
          ...
          <div className="col-span-12 xl:col-span-6 grid grid-cols-12 gap-x-0 gap-y-8">
            <div className="col-span-12 md:col-span-4">
              <div data-ns-animate data-delay="0.4" className="space-y-8">
                ...
                <ul className="sm:space-y-5 space-y-3">
                  <li>
                    <a href="aboutus.html" className="footer-link">
                      About Us
                    </a>
                  </li>
                  <li>
                    <a href="index-isaras.html#contact" className="footer-link">
                      Contact Us
                    </a>
                  </li>
                  <li>
            ...
            <div className="col-span-12 md:col-span-4">
              <div data-ns-animate data-delay="0.6" className="space-y-8">
                ...
                <ul className="sm:space-y-5 space-y-3">
                  <li>
                    <a href="Terms-and-conditions.html" className="footer-link">
                      Terms & Conditions
                    </a>
                  </li>
                  <li>
