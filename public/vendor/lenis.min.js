      ...
      (e.advance = function (t) {
        ...
        if (this.isRunning) {
          ...
          null == (e = this.onUpdate) ||
            e.call(this, this.value, { completed: n }),
            n && this.stop();
        }
      }),
      (e.stop = function () {
      ...
      function t(t, e) {
        ...
        (this.onTouchStart = function (t) {
          ...
          (this.onWheel = function (t) {
            var e = t.deltaX,
              n = t.deltaY;
            i.normalizeWheel && ((e = o(-100, e, 100)), (n = o(-100, n, 100))),
              i.emitter.emit("scroll", {
                type: "wheel",
            ...
            if (
              !(
                ...
                l.composedPath().find(function (t) {
                  return null == t || null == t.hasAttribute
                    ? void 0
            ...
            if ("number" == typeof t) {
              if (
                ...
                this.options.infinite
                  ? T && (this.targetScroll = this.animatedScroll = this.scroll)
                  : (t = o(0, t, this.limit)),
                h)
              )
                return (
          ...
          },
          {
            ...
            get: function () {
              return this.options.infinite
                ? ((e = this.animatedScroll % (t = this.limit)),
                  ((t > 0 && e < 0) || (t < 0 && e > 0)) && (e += t),
                  e)
                : this.animatedScroll;
              var t, e;
