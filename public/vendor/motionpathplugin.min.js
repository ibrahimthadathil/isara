...
!(function (t, e) {
  ...
  function N(t) {
    var n,
      r = (t = (e(t) && l.test(t) && document.querySelector(t)) || t)
        .getAttribute
        ? t
        : 0;
  ...
  function _(t, e, i) {
    ...
    if (
      (i < e &&
        ...
        (function (t) {
          var e = t.length;
          for (t.reverse(); e--; ) t[e].reversed || C(t[e]);
        })(s),
        (s.totalLength = 0)),
      e < 0 || i < 0)
    ) {
    ...
    if (w || a) {
      for (
        h = T < _ || (k && S < I) || (E && P.t < b.t),
          r(s, _, I, b.t) &&
            (_++,
            h ||
              (T++,
              E ? ((P.t = (P.t - b.t) / (1 - b.t)), (S = 0)) : k && (S -= I))),
          Math.abs(1 - (i - e)) < 1e-5
            ? (T = _ - 1)
            : !P.t && T
            ? T--
        ...
        o(c, s[v++ % d]);
      s = c;
    } else if (((f = 1 === P.t ? 6 : O(L, S, P.t)), e !== i))
      for (
        u = O(N, I, E ? b.t / P.t : b.t),
          k && (f += u),
          L.splice(S + f + 2),
          (u || I) && N.splice(0, I + u),
          p = s.length;
  ...
  function S(t, e, n) {
    ...
    var r,
      ...
      O = _[A + n * L - 1],
      R = e ? _[A - 1] : 0;
    for (_.length = S.length = 0, o = e + 2; o < N; o += 6) {
      if (
        ((i = t[o + 4] - C),
        (a = t[o + 2] - C),
        (s = t[o] - C),
        ...
        (p = t[o + 1] - T),
        (l = h = d = v = 0),
        g(i) < 0.01 && g(u) < 0.01 && g(s) + g(p) < 0.01)
      )
        8 < t.length && (t.splice(o, 6), (o -= 6), (N -= 6));
      else
        for (r = 1; r <= L; r++)
          (l =
            h -
            (h =
              ((x = M * r) * x * i + 3 * (y = 1 - x) * (x * a + y * s)) * x)),
    ...
    if (O) for (O -= R; A < _.length; A++) _[A] += O;
    if (_.length && B) {
      if (
        ((t.totalLength = P = _[_.length - 1] || 0),
        P / (t.minLength = B) < 9999)
      )
        for (b = w = 0, r = 0; r < P; r += B) S[b++] = _[w] < r ? ++w : w;
  ...
  function B(t, e) {
    ...
    for (o = n = r = 0; o < t.length; o++)
      (t[o].resolution = ~~e || 12), (r += t[o].length), (n += S(t[o]));
  ...
  function R(t, e, n, r) {
    (n = n || {}), t.totalLength || B(t), (e < 0 || 1 < e) && (e = b(e));
    var o,
      i,
      a,
      s,
      ...
      p = t[0];
    if (e)
      if (1 === e) (u = 1), (h = (p = t[(f = t.length - 1)]).length - 8);
      else {
        if (1 < t.length) {
          for (
            a = t.totalLength * e, l = h = 0;
            (l += t[h++].totalLength) < a;
        ...
        (o = p.samples),
          ...
          r &&
            ...
            (h + 6 < p.length
              ? ((h += 6), (u = 0))
              : f + 1 < t.length && ((h = u = 0), (p = t[++f])));
      }
    else (u = h = f = 0), (p = t[0]);
    return (
      (n.t = u), (n.i = h), (n.path = t), (n.segment = p), (n.segIndex = f), n
    );
  }
  function I(t, e, n, r) {
    var o,
      ...
      g = t[0],
      c = r || {};
    if (((e < 0 || 1 < e) && (e = b(e)), g.lookup || B(t), 1 < t.length)) {
    ...
    return (
      ...
      (a = g.totalLength * e),
      (s = (h = g.lookup.length
        ? g.lookup[e < 1 ? ~~(a / g.minLength) : g.lookup.length - 1] || 0
        : L(o, a, e))
        ? o[h - 1]
        : 0),
      (l = o[h]) < a && ((s = l), (l = o[++h])),
      ...
      (c.x = P(
        (u * u * (g[h + 6] - f) +
          3 * p * (u * (g[h + 4] - f) + p * (g[h + 2] - f))) *
          u +
          f
      )),
      (c.y = P(
        (u * u * (g[h + 7] - (f = g[h + 1])) +
          3 * p * (u * (g[h + 5] - f) + p * (g[h + 3] - f))) *
          u +
          f
      )),
      n &&
        (c.angle = g.totalLength
          ? A(g, h, 1 <= u ? 1 - 1e-9 : u || 1e-9)
          : g.angle || 0),
      c
    );
  }
    ...
    for (n = 0; n < M; n++)
      if (
        ...
        (c = P),
          (d = L),
          ("C" !== v && "S" !== v) ||
            ((c += P - u[u.length - 4]), (d += L - u[u.length - 3])),
          h || (P = L = 0),
        ...
        (c = P - u[u.length - 4]),
          ...
          (n += 2);
      else if ("H" === l) e(P, L, (P = o), L), (n += 1);
      else if ("V" === l) e(P, L, P, (L = o + (h ? L - P : 0))), (n += 1);
      else if ("L" === l || "Z" === l)
        "Z" === l && ((o = f), (a = p), (u.closed = !0)),
          ("L" === l || 0.5 < g(P - o) || 0.5 < g(L - a)) &&
            (e(P, L, o, a), "L" === l && (n += 2)),
          (P = o),
          (L = a);
      else if ("A" === l) {
        if (
          ...
          for (r = 0; r < m.length; r++) u.push(m[r]);
        (P = u[u.length - 2]), (L = u[u.length - 1]);
      }
    return (
      (n = u.length) < 6
        ? (b.pop(), (n = 0))
  ...
  function Y(t, e) {
    ...
    var n,
      ...
      N = b - x,
      C = L - w,
      T = Math.abs(t[y] - x) < 0.001 && Math.abs(t[y + 1] - w) < 0.001;
    for (
      T &&
        (t.push(b, L),
        (b = x),
      ...
      (n = x),
        ...
        (x === b && w === L) ||
          ...
          (C = L - w),
          (h =
            (((s = c(i * i + a * a)) + (l = c(N * N + C * C))) * e * 0.25) /
            c(Math.pow(N / l + i / s, 2) + Math.pow(C / l + a / s, 2))),
          (p =
            x -
            ((u = x - (x - n) * (s ? h / s : 0)) +
              ((((f = x + (b - x) * (l ? h / l : 0)) - u) *
          ...
          (v =
            ...
            ((d = w - (w - r) * (s ? h / s : 0)) +
              ((((m = w + (L - w) * (l ? h / l : 0)) - d) *
                ...
                4 || 0))),
          (x === n && w === r) ||
            M.push(P(u + p), P(d + v), P(x), P(w), P(f + p), P(m + v)));
    return (
      x !== b || w !== L || M.length < 4
        ? M.push(P(b), P(L), P(b), P(L))
        : (M.length -= 2),
      2 === M.length
        ? M.push(x, w, x, w, x, w)
        : T && (M.splice(0, 6), (M.length = M.length - 6)),
      M
    );
  }
  function V(t) {
  ...
  function j(t) {
    ...
    !(nt in t.style) &&
      ...
      (rt = (nt = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode); );
    if (((U = window), (J = new at()), e)) {
  ...
  function F(t, e) {
    if (t.parentNode && (H || j(t))) {
      var n = q(t),
        ...
        l = H.createElementNS
          ? H.createElementNS(r.replace(/^https/, "http"), o)
          : H.createElement(o);
      return (
        e &&
          (n
  ...
  function G(t, e) {
    var n,
      ...
      f = t.parentNode;
    if (t === U) return t;
    if ((u.length || u.push(F(t, 1), F(t, 2), F(t, 3)), (n = l ? $ : W), l))
      h
        ? ((i =
            -(o = (function (t) {
              var e,
                ...
                n ||
                  ...
                  e
                    ...
                    : t.style.removeProperty(
                        nt.replace(/([A-Z])/g, "-$1").toLowerCase()
                      )),
                n || J.clone()
              );
            })(t)).e / o.a),
      ...
      if (((i = a = 0), tt))
        for (
          ...
          4 < (U.getComputedStyle(o)[nt] + "").length &&
            ((i = o.offsetLeft), (a = o.offsetTop), (o = 0));
      if (
        "absolute" !== (s = U.getComputedStyle(t)).position &&
        "fixed" !== s.position
      )
        for (r = t.offsetParent; f && f !== r; )
          (i += f.scrollLeft || 0), (a += f.scrollTop || 0), (f = f.parentNode);
  ...
  var H,
    ...
    it = [],
    at =
      (((et = st.prototype).inverse = function () {
        var t = this.a,
          e = this.b,
          n = this.c,
          r = this.d,
      ...
      (et.apply = function (t, e) {
        ...
        var n = t.x,
          ...
          h = this.f;
        return (
          (e.x = n * o + r * a + l || 0), (e.y = n * i + r * s + h || 0), e
        );
      }),
      st);
    ...
    var o = (function (t) {
      ...
      p = new at(
        ...
        s.top +
          (f
            ? 0
            : U.pageYOffset || H.scrollTop || D.scrollTop || Q.scrollTop || 0)
      );
    if ((u.removeChild(a), o))
      for (s = o.length; s--; )
        ((l = o[s]).scaleX = l.scaleY = 0), l.renderTransform(1, l);
    return e ? p.inverse() : p;
  }
  function ht(t, e, n, r) {
    for (var o = e.length, i = 2 === r ? 0 : r, a = 0; a < o; a++)
      (t[i] = parseFloat(e[a][n])), 2 === r && (t[i + 1] = 0), (i += 2);
    return t;
  }
  function ut(t, e, n) {
    ...
    return (
      (e =
        "cubic" === a.type
          ? [e]
          : (!1 !== a.fromCurrent &&
              e.unshift(ut(n, r, s), o ? ut(n, o, l) : 0),
            a.relative && ft(e),
            [(o ? Y : X)(e, a.curviness)])),
      (e = i(Ct(e, n, a))),
      Tt(t, n, r, e, "x", s),
  ...
  function ct(t, e, n) {
    ...
    return (
      ...
      n.apply(i || a ? o.apply({ x: i, y: a }) : { x: o.e, y: o.f })
    );
  }
  function dt(t, e, n, r) {
    var o,
      i = lt(t.parentNode, !0, !0),
      a = i.clone().multiply(lt(e)),
      s = ct(t, n, i),
      l = ct(e, r, i),
      h = l.x,
      u = l.y;
    return (
      ...
      "auto" === r &&
        ...
        ((o = e.getAttribute("d").match(Nt) || []),
        (h += (o = a.apply({ x: +o[0], y: +o[1] })).x),
        (u += o.y)),
      o && ((h -= (o = a.apply(e.getBBox())).x), (u -= o.y)),
      (a.e = h - s.x),
      (a.f = u - s.y),
      a
    );
  ...
  var mt,
    ...
    Lt = "y,translateY,top,marginTop,yPercent".split(","),
    Mt = Math.PI / 180,
    Nt = /[-+\.]*\d+\.?(?:e-|e\+)?\d*/g,
    Ct = function (t, e, n) {
      var r,
        ...
        ? (a &&
            ("self" === a || (r = xt(a)[0] || e) === e
              ...
              : (u && !1 !== u[2]
                ...
                (i = (o = dt(e, r, u, "auto")).apply({ x: f, y: p })),
                k(
                  t,
                  o.a,
                  o.b,
          ...
          s
            ? k(t, s.a, s.b, s.c, s.d, s.e, s.f)
            : (l || h) && k(t, 1, 0, 0, 1, l || 0, h || 0),
          t)
        : N("M0,0L0,0");
    },
    ...
    At = {
      ...
      init: function (t, e, n) {
        ...
        if (
          ...
          p))
            o !== u &&
              o !== f &&
              i.push(pt(this, ht([], a, o, 2), t, o, 0, g, e, yt(a[0][o])));
        }
      },
      render: function (t, e) {
        var n = e.rawPaths,
            ...
            return "path" !== N && t.getBBox
              ? ((l = (function (t, e) {
                ...
                "rect" === N
                  ...
                  : ("polyline" !== N && "polygon" !== N) ||
                    ((n =
                      "M" +
                      (r = (f =
                        (t.getAttribute("points") + "").match(a) ||
                        []).shift()) +
                      "," +
                      (o = f.shift()) +
                      " L" +
      ...
      arrayToRawPath: function (t, e) {
        ...
        return (
          e.relative && ft(n), ["cubic" === e.type ? n : Y(n, e.curviness)]
        );
      },
    };
  !(
