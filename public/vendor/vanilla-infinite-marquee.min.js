class InfiniteMarquee {
  constructor(e = {}) {
    (this.element =
      "string" == typeof e.element
        ? [...document.querySelectorAll(e.element)]
        : e.element),
      ...
      (this.scrollType =
        "top" === e.direction || "bottom" === e.direction
          ? "vertical"
          : "horizontal"),
      ...
      "undefined" != typeof window &&
        (this.destroyOnResponsive(),
        (this.destroyOnMobile || this.destroyOnDesktop) &&
          window.addEventListener(
            "resize",
            this.destroyOnResponsive.bind(this)
          ));
  }
  init() {
    if (
      ...
      this.debugging &&
        console.error("🚊 Infinite Marquee - Failed to Initialize");
    else {
      if (
        (this.debugging,
        window.matchMedia("(prefers-reduced-motion: reduce)").matches &&
          ((this.animateMotion = !1), this.debugging),
  ...
  duplicateOriginalNodes(e) {
    ...
    for (let e = 0; e < t.length; e++) {
      ...
      s.setAttribute("aria-hidden", !0), i.push(s);
    }
    for (const t of i) e.appendChild(t);
    this.debugging;
  }
  duplicateContainer(e) {
    ...
    const n =
        "vertical" === this.scrollType
          ...
          : this.duplicateCount,
      o = Array.from({ length: n }, () => i.cloneNode(!0));
    ...
    const i = (e) => {
      ...
      s = () => {
        if (this.isMarqueeInitialized) {
          ...
          if (
            (e.style.setProperty("--_speed", `${a}ms`),
            ...
            const i =
                (t.matches &&
                  this.mobileSettings &&
                  this.mobileSettings.gap &&
                  this.mobileSettings.gap.horizontal) ||
                this.gap.horizontal,
              s =
                (t.matches &&
                  this.mobileSettings &&
                  this.mobileSettings.gap &&
                  this.mobileSettings.gap.vertical) ||
                this.gap.vertical;
            this.gap.horizontal && e.style.setProperty("--_hGap", i),
              this.gap.vertical && e.style.setProperty("--_vGap", s);
          } else {
            const i =
                (t.matches && this.mobileSettings.spaceBetween) ||
                this.spaceBetween,
  ...
  destroyOnResponsive() {
    const e = `${this.scrollType}-marquee-inner`,
      t = this.element;
    "undefined" != typeof window &&
      ((window.innerWidth <= this.breakpointSize && this.destroyOnMobile) ||
      (window.innerWidth >= this.desktopBreakpoint && this.destroyOnDesktop)
        ? this.manageMarquee(t, e)
        : this.isMarqueeInitialized ||
          (this.init(), (this.isMarqueeInitialized = !0)));
  }
  manageMarquee(e, t) {
    this.isMarqueeInitialized &&
      (this.destroy(e, t), (this.isMarqueeInitialized = !1), this.debugging);
  }
  removeClassesAfter(e, t) {
    if (t && t.classList) {
      ...
      for (let s = 0; s < t.classList.length; s++) {
        ...
        i && (t.classList.remove(n), s--), n === e && (i = !0);
      }
    }
  }
  destroy(e, t) {
    if (e) {
      ...
      for (let t = 1; t < i.length; t++) e.removeChild(i[t]);
      const s = e.firstElementChild;
      if (
        s &&
        (s.querySelectorAll('[aria-hidden="true"]').forEach((e) => {
          s.removeChild(e);
        }),
