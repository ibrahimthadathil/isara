    ...
    function (e) {
      ...
      function P(e) {
        ...
        if (((l = !1), (o = !1), h.push(e), !(h.length < 2))) {
          if (((l = !0), (g.scaleStart = S()), !g.slideEl)) {
            (g.slideEl = e.target.closest(
              `.${t.params.slideClass}, swiper-slide`
            )),
              g.slideEl || (g.slideEl = t.slides[t.activeIndex]);
            let a = g.slideEl.querySelector(`.${s.containerClass}`);
            if (
              (a &&
      ...
      function L(e) {
        ...
        const s = t.params.zoom,
          a = t.zoom,
          i = h.findIndex((t) => t.pointerId === e.pointerId);
        i >= 0 && (h[i] = e),
          h.length < 2 ||
            ((o = !0),
            (g.scaleMove = S()),
            g.imageEl &&
              ((a.scale = (g.scaleMove / g.scaleStart) * c),
              a.scale > g.maxRatio &&
                (a.scale = g.maxRatio - 1 + (a.scale - g.maxRatio + 1) ** 0.5),
              a.scale < s.minRatio &&
                (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) ** 0.5),
              (g.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`)));
      }
      function I(e) {
        if (!M(e)) return;
        ...
        i >= 0 && h.splice(i, 1),
          l &&
            ...
            (o = !1),
            g.imageEl &&
              ((a.scale = Math.max(Math.min(a.scale, g.maxRatio), s.minRatio)),
      ...
      function A(e) {
        ...
        const i = v.width * a.scale,
          r = v.height * a.scale;
        if (
          ((v.minX = Math.min(g.slideWidth / 2 - i / 2, 0)),
          (v.maxX = -v.minX),
        ...
        e.cancelable && e.preventDefault(),
          ...
          (v.isMoved = !0);
        const n = (a.scale - c) / (g.maxRatio - t.params.zoom.minRatio),
      ...
      function k(e) {
        ...
        const a = -3 * (e.clientX - m.x),
          ...
          w = -f,
          b = Math.max(Math.min(v.startX + a, h), p),
          y = Math.max(Math.min(v.startY + i, w), f);
        (g.imageWrapEl.style.transitionDuration = "0ms"),
      ...
      function O(e) {
        ...
        if (!g.slideEl) {
          ...
          let s = g.slideEl.querySelector(`.${a.containerClass}`);
          s &&
            ...
            (g.imageEl = s),
            (g.imageWrapEl = s
              ? E(g.imageEl, `.${a.containerClass}`)[0]
              : void 0);
        }
        if (!g.imageEl || !g.imageWrapEl) return;
        let i, r, l, o, d, p, u, m, h, b, y, x, S, M, C, P, L, I;
        t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "hidden"),
          (t.wrapperEl.style.touchAction = "none")),
          g.slideEl.classList.add(`${a.zoomedSlideClass}`),
          void 0 === v.touchesStart.x && e
            ? ((i = e.pageX), (r = e.pageY))
            : ((i = v.touchesStart.x), (r = v.touchesStart.y));
        const z = c,
          ...
          !e || (1 === c && A)
            ...
            : ((L = g.slideEl.offsetWidth),
              ...
              "number" == typeof v.currentY
                ? ((u = (v.currentX * s.scale) / z),
                  (m = (v.currentY * s.scale) / z))
                : ((u = d * s.scale), (m = p * s.scale)),
              u < S && (u = S),
              u > C && (u = C),
              m < M && (m = M),
              m > P && (m = P)),
          A && 1 === s.scale && ((g.originX = 0), (g.originY = 0)),
          (v.currentX = u),
          (v.currentY = m),
      ...
      function Y() {
        ...
        t.wrapperEl.addEventListener("pointerdown", P, s),
          ...
          ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            t.wrapperEl.addEventListener(e, I, s);
          }),
          t.wrapperEl.addEventListener("pointermove", A, a);
      }
      function B() {
        const e = t.zoom;
        if (!e.enabled) return;
        ...
        t.wrapperEl.removeEventListener("pointerdown", P, s),
          ...
          ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            t.wrapperEl.removeEventListener(e, I, s);
          }),
          t.wrapperEl.removeEventListener("pointermove", A, a);
      }
          ...
          t.zoom.enabled &&
            (function (e) {
              ...
              s.android && e.cancelable && e.preventDefault(),
                (v.isTouched = !0);
              const a = h.length > 0 ? h[0] : e;
              (v.touchesStart.x = a.pageX), (v.touchesStart.y = a.pageY);
            })(s);
        }),
        a("touchEnd", (e, s) => {
          t.zoom.enabled &&
            (function () {
              ...
              0 !== b.x && (s = Math.abs((r - v.currentX) / b.x)),
                0 !== b.y && (a = Math.abs((l - v.currentY) / b.y));
