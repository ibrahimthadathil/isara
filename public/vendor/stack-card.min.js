      ...
      var s = function (n) {
        for (var i in n)
          Object.prototype.hasOwnProperty.call(n, i) &&
            (t && "[object Object]" === Object.prototype.toString.call(n[i])
              ? (e[i] = extend(!0, e[i], n[i]))
              : (e[i] = n[i]));
      };
      n < i;
      n++
...
(Math.easeInOutQuad = function (e, t, n, i) {
  ...
  (function () {
    ...
    function t() {
      e.length > 0 && (i(!1), window.addEventListener("keydown", n)),
  ...
  (function () {
    var e = function (e) {
      (this.element = e),
        ...
        (function (e) {
          i(e),
            new IntersectionObserver(t.bind(e), { threshold: [0, 1] }).observe(
              e.element
            );
        })(this),
        (function (e) {
    ...
    function i(e) {
      ...
      for (var n = 0; n < e.items.length; n++)
        isNaN(e.marginY)
          ? (e.items[n].style.transform = "none;")
          : (e.items[n].style.transform =
              "translateY(" + e.marginY * n + "px)");
    }
    function s() {
            ...
            if (n > 0) {
              var i =
                t == this.items.length - 1
                  ? 1
                  : (this.cardHeight - 0.05 * n) / this.cardHeight;
              this.items[t].style.transform =
                "translateY(" + this.marginY * t + "px) scale(" + i + ")";
            } else
              this.items[t].style.transform =
